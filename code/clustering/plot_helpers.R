...
plot_circos <- function(hc, main) {
  ...
  dend = color_branches(dend, k=10, col=c("black","darkgrey"),alpha=0.9) #col=viridis(10, begin = 0.1)) 
  ...
  for(i in 1:10) do.call(circos.text,args=list(nums[i],max_height+0.88,i,cex=0.6))
}
